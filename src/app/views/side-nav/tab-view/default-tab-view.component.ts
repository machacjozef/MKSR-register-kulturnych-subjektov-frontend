...
import {SideNavCasesCaseViewComponent} from "../cases/side-nav-cases-case-view.component";
import {DefaultTabbedTaskViewComponent} from "@netgrif/components";
        ...
        return [
            {
                ...
                canBeClosed: false,
                tabContentComponent: SideNavCasesCaseViewComponent,
                injectedObject: {
